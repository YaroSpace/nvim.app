...
(defn nvim-database-system
  [config]
  (component/system-map :database-component (database-component/new config)))

(defn nvim-app-system
  [config]
  (-> (component/system-map :repl (repl-component/new config)
      ...
      (component/system-using {:app [:database-component
                                     ; :xtdb-component
                                     :pedestal-component :sched :repl]})))

(defn -main
  []
  (try (let [system (-> (config/read-config)
