   ...
   [:div {:class "flex items-start justify-between"}
    ...
    (when (pos? stars)
      [:div {:class "flex flex-col items-end pt-2 pl-2"}
       (star stars star-icon "text-sm text-yellow-500" "Total")
       (star (- stars stars_week) growth-icon-w "text-sm text-orange-500" "Stars since beginning of the week")
       (star (- stars stars_month) growth-icon-m "text-sm text-red-500" "Stars since beginning of the month")])]])
